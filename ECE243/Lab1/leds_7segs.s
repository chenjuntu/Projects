...
.equ ADDR_7SEG, 0x10000020
.equ ADDR_GREENLEDS, 0x10000010	/* 9 bits corresponding to 9 LEDGs starting at this address */
.equ ADDR_REDLEDS, 0x10000000	/* 18 bits corresponding to 18 LEDRd starting at this address */   
...
main:
 ...
 LOOP:
  ...
  stwio r15,0(r12)  /* Write to Green LEDs */
  stwio r15,0(r13)  /* Write to Red LEDs */

  /*stwio r16,0(r5)*/  /* Write to 7-segment displays */
  add r4,r16,r0
  call DISPLAY
 ...
 * 
	R7: the number to be written to the 7-Seg
	R2: counter of the loop. counts from 0 to 3
*/
